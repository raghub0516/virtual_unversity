...
<form name="insert" method="get" action="insertbook.jsp" onsubmit="return false">
...
<tr>
	...
	<tr><td align="Right" width="25%"><font face="Verdana"  size="2" color="Navy"><b>First Name</b></td><td align="Left" width="25%"><font face="Arial" size="2" color="Navy"><input type="text" name="fName" size=15></td><td align="Right" width="25%"><font face="Verdana"  size="2" color="Navy"><b>Last Name</b></font></td><td align="Left" width="25%"><input type="text" name="lName" size=15></td></tr>

	<tr><td colspan=4></td></tr>
	<tr><td align="right" colspan=2 width="50%"><font face="Verdana" size="2" color="Navy"><b>Date of Birth</b></font></td><td colspan=2><select name="date">
	...
	<input type="text" name="year" size=7></input>
	</td></tr>

	<tr><td align="right" colspan=2 width="50%"><font face="Verdana" size="2" color="Navy"><b>Sex</b></font></td><td colspan=2><input type="radio" name="male" value="Male">Male</input>&nbsp;&nbsp;<input type="radio" name="fem" value="Female">Female</input></td></tr>
	<tr><td align="right" colspan=2 width="50%"><font face="Verdana" size="2" color="Navy"><b>Address</b></font></td><td colspan=2><textarea rows="5" columns="30"></textarea></td></tr>
	<tr><td align="right" width="25%"><font face="Verdana" size="2" color="Navy"><b>City</b></font></td><td align="left"><input type="text" name="city" size="15"></input></td>
	    <td align="right" width="25%"><font face="Verdana" size="2" color="Navy"><b>Pincode</b></font></td><td align="left"><input type="text" name="pin" size="15"></td></tr>
	<tr><td align="right" width="25%" ><font face="Verdana" size="2" color="Navy"><b>Phone no</b></font></td><td  align="left"><input type="text" name="telno" size="15"></input></td>
	<td align="right" width="25%"><font face="Verdana" size="2" color="Navy"><b>Mobile no</b></font></td><td  align="left"><input type="text" name="mobno" size="15"></td></tr>
	<tr><td align="right" colspan=2 width="50%"><font face="Verdana" size="2" color="Navy"><b>E-mail</b></font></td><td colspan=2><input type="text" name="email" size=35></input></td></tr>
	<tr><td align="right" colspan=2 width="50%"><font face="Verdana" size="2" color="Navy"><b>Qualification</b></font></td><td colspan=2><input type="text" name="qual" size=25></input></td></tr>
...
<option name="course">Course</option><option name="project">Project</option></td>
	<td align="right" width="25%"><font face="Verdana" size="2" color="Navy"><b>Code</b></font></td><td align="left"><select name="code">	
...
joining= new String(request.getParameter("joining"));

if(joining.equals("Course"))
{
 sql1="SELECT C_name FROM course_details";
	...
	while(rs.next())
	{
for(var t=0;t<rs.count();t++)
{
var course[t]=rs.getString(2);
}

//<option name="course"><%=rs.getString(2)%></option></td></tr>		     
}
}
}
else
{
 sql1="SELECT P_name FROM project_details WHERE P_name=?";
	...
	while(rs.next())
	{
	    ...
	    <option name="project"><%=rs.getString(2)%></option></td></tr>		     
