...
<tr><td width=25% height=156><div align="center"><img src="Images\custcare.gif" width="164" height="89"></div></td><td width=60% align="Center">
...
<tr><td colspan="3" height=29 bgcolor="orange"><a href="administrator.html"><font size=3 face="Maiandra GD" color="#000000"><b>Home</b></font></a>&nbsp;<a href="adminupdeletepro.jsp"><font size=3 face="Maiandra GD" color="#000000"><b>Back</b></font></a>&nbsp;<a href="administrator.html"><font size=3 face="Maiandra GD" color="#000000"><b>Sign out</b></font></a></td></tr>
<tr><td colspan=3 align="center"><table border=0 height=100% width=100% bgcolor="#bcdeff"><tr><td align=center colspan=3 height=20%><font size=4 face="Verdana" color="Navy">DELETE THE PROJECT
	</font></td></tr>
...
<form method="post" action="adminupdelpro.jsp">
...
<tr><td align="center"><table width="50%"  border="2" align="center">
  ...
  <tr> 
    ...
    <td width="70%"><%=rs.getString("P_name") %></td>
  </tr>
  <tr> 
    <td width="30%"><b>Prerequisity:</b></td>
    <td width="70%"><%=rs.getString("P_prerequisite") %></td>
  </tr>
  <tr> 
    <td width="30%"><b>Duration:</b></td>
    <td width="70%"><%=rs.getString("P_duration") %></td>
  </tr>
  <tr> 
    <td width="30%"><b>Lump fee:</b></td>
    <td width="70%"><%=rs.getString("P_lump_fee") %></td>
  </tr>
  <tr> 
    <td width="30%"><b>First Installment:</b></td>
    <td width="70%"><%=rs.getString("P_ins_first") %></td>
  </tr>
  <tr> 
    <td width="30%"><b>Second Installment:</b></td>
    <td width="70%"><%=rs.getString("P_ins_second") %></td>
  </tr>
