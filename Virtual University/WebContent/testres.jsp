		...
		<table border=0 width=100% height=100% bgcolor="#af8080">
			<form name="test" method="post" action="testmark.jsp">
				...
				<tr>
					...
					<td bgcolor="#af8080" align="right" valign="top" width="5%"
						height="5%"><font size=3 color="#000000"><b><%=j%></b></font></td>
					<td bgcolor="#af8080" align="left" width="40%" height="10%"><b><fontze=2 face=verdana color="#000000"><%=RS.getString(2)%></b></font><br>
						<font size=2 face=verdana color="#ffffff"><input type="radio" name="a<%=j%>" value="a"><b>a.<%=RS.getString(3)%></b></input></font><br>
						<font size=2 face=verdana color="#ffffff"><input type="radio" name="a<%=j%>" value="b"><b>b.<%=RS.getString(4)%></b></input></font><br>
						<font size=2 face=verdana color="#ffffff"><input type="radio" name="a<%=j%>" value="c"><b>c.<%=RS.getString(5)%></b></input></font><br>
						<font size=2 face=verdana color="#ffffff"><input type="radio" name="a<%=j%>" value="d"><b>d.<%=RS.getString(6)%></b></input></font></td>
				</tr>
				...
				<%
					ans[j] = RS.getString(7);
						...
						application.setAttribute("Answers", ans);
				...
				<%
						...
						e.printStackTrace();
						System.out
								.println("ohohooooooooooooooooooooooooooohohooooooooooohhhhh");
					}
				%>
