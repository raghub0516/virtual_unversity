...
<%
   ...
   try
   {
          ...
          int B_pincode = Integer.parseInt(request.getParameter("B_pincode"));  
          int B_phno = Integer.parseInt(request.getParameter("B_phno"));
          int B_mobile = Integer.parseInt(request.getParameter("B_mobile"));
     ...
     String query = "insert into Booking values ('"+B_code+"','"+B_fname+"','"+B_lname+"','"+B_dob+"','"+B_sex+"','"+B_address+"','"+B_city+"','"+B_pincode+"','"+B_phno+"','"+B_mobile+"','"+B_email+"','"+B_quali+"','"+B_joining+"')"; 
